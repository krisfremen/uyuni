...
public class MockConnection extends CobblerConnection {
    ...
    public Object invokeMethod(String name, Object... args) {
        ...
        switch (name) {
            ...
            case "modify_profile":
                ...
                modifyItem(profiles, (String) args[0], args[1], args[2]);
                break;
            case "get_profile":
            ...
            case "modify_distro":
                ...
                modifyItem(distros, (String) args[0], args[1], args[2]);
                break;
            case "get_distro":
            ...
            case "modify_system":
                modifyItem(systems, (String) args[0], args[1], args[2]);
                break;
            case "get_system":
            ...
            case "modify_image":
                modifyItem(images, (String) args[0], args[1], args[2]);
                break;
            case "rename_image":
            ...
            case "get_item_resolved_value":
                ...
                // TODO: Implement resolved dict for objects
                return null;
            case "sync":
                return true;
            case "version":
    ...
    private void modifyItem(List<MockItem> collection, String xmlrpcHandle, Object arg1, Object arg2) {
    ...
    private List<Map<String, Object>> convertItemListToMapList(List<MockItem> collection, boolean resolved) {
        ...
        for (MockItem item : collection) {
            if (resolved) {
                returnValue.add(item.getDataMapResolved());
            }
            else {
                returnValue.add(item.getDataMap());
            }
        }
        return returnValue;
    }
